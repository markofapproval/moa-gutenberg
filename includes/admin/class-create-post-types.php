...
function moa_blocks_create_post_types() {
	...
	$args = [ 'templates' => array(
		...
		'description'           => __( 'Templates for your website design', 'text_domain' ),
		'labels'                => $labels,
...
//		'taxonomies'            => array( 'category' ),
	...
	$args = apply_filters( 'moa_blocks_post_type_args', $args );
	register_post_type( 'moa_template', $args[ 'templates' ] );
